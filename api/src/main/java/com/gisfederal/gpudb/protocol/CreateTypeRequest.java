...
public class CreateTypeRequest implements IndexedRecord {
    ...
    public static final class Properties {
         ...
         * (e.g. {@link
         * com.gisfederal.gpudb.GPUdb#filterByBox(FilterByBoxRequest)})-i.e. it
         * is mutually exclusive to the 'data' property. Any 'bytes' type
         ...
         * com.gisfederal.gpudb.GPUdb#filter(FilterRequest)}, {@link
         * com.gisfederal.gpudb.GPUdb#filterByList(FilterByListRequest)}, and
         * {@link
         * com.gisfederal.gpudb.GPUdb#filterByValue(FilterByValueRequest)} work
         * as usual but {@link
