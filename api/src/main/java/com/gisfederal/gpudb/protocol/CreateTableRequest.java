 ...
 * com.gisfederal.gpudb.GPUdb#createType(CreateTypeRequest)}). The table will
 * be created inside a collection if the option *collection_name* is specified.
 * If that collection does not already exist then it will be created. To create
 * a new, empty collection specify the collection name in {@code tableName},
 * leave {@code typeId} blank, and set the *is_collection* option to 'true'.
 */
public class CreateTableRequest implements IndexedRecord {
    ...
    public static final class Options {
        ...
        /**
         * If {true}@{choice of key no_error_if_exists}, prevents an error from
     ...
     *         currently existing GPUdb table of a different type (requests
     *         with existing table of the same name and type id are silently
     *         ignored). Cannot be an empty string.
     * 
     */
