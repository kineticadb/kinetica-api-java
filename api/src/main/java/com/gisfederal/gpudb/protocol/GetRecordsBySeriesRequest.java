 ...
 * <p>
 * In contrast to {@link
 * com.gisfederal.gpudb.GPUdb#getRecordsRaw(GetRecordsRequest)} this returns
 * records grouped by series/track. So if {@code offset} is 0 and {@code limit}
 * is 5 this operation would return the first 5 series/tracks in {@code
