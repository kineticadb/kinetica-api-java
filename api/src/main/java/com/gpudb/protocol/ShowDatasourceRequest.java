...
public class ShowDatasourceRequest implements IndexedRecord {
     ...
     *                 {@link Map}.
     */
    public ShowDatasourceRequest(String name, Map<String, String> options) {
        this.name = (name == null) ? "" : name;
        this.options = (options == null) ? new LinkedHashMap<String, String>() : options;
    }

    /**
     * Name of the data source for which to retrieve information. The name must
     * refer to a currently existing data source. If '*' is specified,
     ...
     */
    public ShowDatasourceRequest setName(String name) {
        this.name = (name == null) ? "" : name;
        return this;
    }
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public ShowDatasourceRequest setOptions(Map<String, String> options) {
        this.options = (options == null) ? new LinkedHashMap<String, String>() : options;
        return this;
    }
