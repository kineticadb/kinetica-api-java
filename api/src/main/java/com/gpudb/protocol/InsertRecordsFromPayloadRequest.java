...
public class InsertRecordsFromPayloadRequest implements IndexedRecord {
    ...
    /**
     * 
     * @return Records formatted as delimited text
     * 
     */
    ...
    /**
     * 
     * @return Records formatted as binary data
     * 
     */
    ...
    /**
     * 
     * @return Options used when creating the target table. Includes type to
     *         use. The other options match those in {@link
     *         com.gpudb.GPUdb#createTable(CreateTableRequest)}
     *         <ul>
     *                 <li> {@link
     *         com.gpudb.protocol.InsertRecordsFromPayloadRequest.CreateTableOptions#TYPE_ID
