 ...
 * com.gpudb.GPUdb#adminRebalance(AdminRebalanceRequest) GPUdb.adminRebalance}.
 * <p>
 ...
 * GPUdb.adminRebalance} is invoked after a change is made to the cluster,
 * e.g., a host was added or removed, <a
 * href="../../../../../../concepts/tables/#sharding" target="_top">sharded
 * data</a> will be evenly redistributed across the cluster by number of shards
 * per rank while unsharded data will be redistributed across the cluster by
 * data size per rank
 * <p>
 * * If {@link com.gpudb.GPUdb#adminRebalance(AdminRebalanceRequest)
 * GPUdb.adminRebalance} is invoked at some point when unsharded data (a.k.a.
...
public class AdminRebalanceRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link AdminRebalanceRequest}
    ...
    public static final class Options {
         ...
         * Cannot be used simultaneously with {@link Options#TABLE_EXCLUDES
         * TABLE_EXCLUDES}. This parameter is ignored if {@link
         * Options#REBALANCE_UNSHARDED_DATA REBALANCE_UNSHARDED_DATA} is {@link
         * Options#FALSE FALSE}.
         */
         ...
         * applicable to sharded tables because they are always rebalanced.
         * Cannot be used simultaneously with {@link Options#TABLE_INCLUDES
         * TABLE_INCLUDES}. This parameter is ignored if {@link
         * Options#REBALANCE_UNSHARDED_DATA REBALANCE_UNSHARDED_DATA} is {@link
         * Options#FALSE FALSE}.
         */
         ...
         * to reclaim memory and disk space. Default is {@link Options#TRUE
         * TRUE}, unless {@link Options#REPAIR_INCORRECTLY_SHARDED_DATA
         * REPAIR_INCORRECTLY_SHARDED_DATA} is set to {@link Options#TRUE
         * TRUE}.
         * Supported values:
         * <ul>
         *     <li>{@link Options#TRUE TRUE}
        ...
        /**
         * If set to {@link Options#TRUE TRUE}, ignore rebalance options and
         * attempt to perform compaction of deleted records to reclaim memory
         ...
         * GPUdb.adminVerifyDb} reports an error in sharding alignment. This
         * can be done as part of a typical rebalance after expanding the
         * cluster or in a standalone fashion when it is believed that data is
         * sharded incorrectly somewhere in the cluster. Compaction will not be
         * performed by default when this is enabled. If this option is set to
         * {@link Options#TRUE TRUE}, the time necessary to rebalance and the
     ...
     *                         used simultaneously with {@link
     *                         Options#TABLE_EXCLUDES TABLE_EXCLUDES}. This
     *                         parameter is ignored if {@link
     *                         Options#REBALANCE_UNSHARDED_DATA
     *                         REBALANCE_UNSHARDED_DATA} is {@link
     *                         Options#FALSE FALSE}.
     ...
     *                         because they are always rebalanced. Cannot be
     *                         used simultaneously with {@link
     *                         Options#TABLE_INCLUDES TABLE_INCLUDES}. This
     *                         parameter is ignored if {@link
     *                         Options#REBALANCE_UNSHARDED_DATA
     *                         REBALANCE_UNSHARDED_DATA} is {@link
     *                         Options#FALSE FALSE}.
     ...
     *                     <li>{@link Options#COMPACT_AFTER_REBALANCE
     *                         COMPACT_AFTER_REBALANCE}: Perform compaction of
     *                         deleted records once the rebalance completes to
     *                         reclaim memory and disk space. Default is {@link
     *                         Options#TRUE TRUE}, unless {@link
     *                         Options#REPAIR_INCORRECTLY_SHARDED_DATA
     *                         REPAIR_INCORRECTLY_SHARDED_DATA} is set to
     *                         {@link Options#TRUE TRUE}.
     *                         Supported values:
     *                         <ul>
     *                             <li>{@link Options#TRUE TRUE}
     *                             <li>{@link Options#FALSE FALSE}
     *                         </ul>
     *                         The default value is {@link Options#TRUE TRUE}.
     *                     <li>{@link Options#COMPACT_ONLY COMPACT_ONLY}: If
     *                         set to {@link Options#TRUE TRUE}, ignore
     ...
     *                         FALSE}.
     *                     <li>{@link Options#REPAIR_INCORRECTLY_SHARDED_DATA
     *                         REPAIR_INCORRECTLY_SHARDED_DATA}: Scans for any
     *                         data sharded incorrectly and re-routes the data
     *                         to the correct location. Only necessary if
     *                         {@link
     *                         com.gpudb.GPUdb#adminVerifyDb(AdminVerifyDbRequest)
     *                         GPUdb.adminVerifyDb} reports an error in
     *                         sharding alignment. This can be done as part of
     *                         a typical rebalance after expanding the cluster
     *                         or in a standalone fashion when it is believed
     *                         that data is sharded incorrectly somewhere in
     *                         the cluster. Compaction will not be performed by
     *                         default when this is enabled. If this option is
     *                         set to {@link Options#TRUE TRUE}, the time
     ...
     *         list of unsharded table names to rebalance. Not applicable to
     *         sharded tables because they are always rebalanced. Cannot be
     *         used simultaneously with {@link Options#TABLE_EXCLUDES
     *         TABLE_EXCLUDES}. This parameter is ignored if {@link
     *         Options#REBALANCE_UNSHARDED_DATA REBALANCE_UNSHARDED_DATA} is
     *         {@link Options#FALSE FALSE}.
     *     <li>{@link Options#TABLE_EXCLUDES TABLE_EXCLUDES}: Comma-separated
     *         list of unsharded table names to not rebalance. Not applicable
     *         to sharded tables because they are always rebalanced. Cannot be
     *         used simultaneously with {@link Options#TABLE_INCLUDES
     *         TABLE_INCLUDES}. This parameter is ignored if {@link
     *         Options#REBALANCE_UNSHARDED_DATA REBALANCE_UNSHARDED_DATA} is
     *         {@link Options#FALSE FALSE}.
     ...
     *         default value is '10'.
     *     <li>{@link Options#COMPACT_AFTER_REBALANCE COMPACT_AFTER_REBALANCE}:
     *         Perform compaction of deleted records once the rebalance
     *         completes to reclaim memory and disk space. Default is {@link
     *         Options#TRUE TRUE}, unless {@link
     *         Options#REPAIR_INCORRECTLY_SHARDED_DATA
     *         REPAIR_INCORRECTLY_SHARDED_DATA} is set to {@link Options#TRUE
     *         TRUE}.
     ...
     *         </ul>
     *         The default value is {@link Options#TRUE TRUE}.
     *     <li>{@link Options#COMPACT_ONLY COMPACT_ONLY}: If set to {@link
     *         Options#TRUE TRUE}, ignore rebalance options and attempt to
     ...
     *         necessary if {@link
     *         com.gpudb.GPUdb#adminVerifyDb(AdminVerifyDbRequest)
     *         GPUdb.adminVerifyDb} reports an error in sharding alignment.
     *         This can be done as part of a typical rebalance after expanding
     *         the cluster or in a standalone fashion when it is believed that
     *         data is sharded incorrectly somewhere in the cluster. Compaction
     *         will not be performed by default when this is enabled. If this
     *         option is set to {@link Options#TRUE TRUE}, the time necessary
