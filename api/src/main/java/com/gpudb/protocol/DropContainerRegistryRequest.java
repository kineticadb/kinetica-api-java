...
public class DropContainerRegistryRequest implements IndexedRecord {

    private static final Schema schema$ = SchemaBuilder
            .record("DropContainerRegistryRequest")
            .namespace("com.gpudb")
            .fields()
    ...
    public boolean equals(Object obj) {
        ...
        DropContainerRegistryRequest that = (DropContainerRegistryRequest)obj;
