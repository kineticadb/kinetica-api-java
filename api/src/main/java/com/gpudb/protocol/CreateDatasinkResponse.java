 ...
 */
public class CreateDatasinkResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("CreateDatasinkResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     */
    public CreateDatasinkResponse() {
    }

    /**
     * Value of {@link com.gpudb.protocol.CreateDatasinkRequest#getName()
     * name}.
     *
     ...
     */
    public CreateDatasinkResponse setName(String name) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public CreateDatasinkResponse setInfo(Map<String, String> info) {
    ...
    public boolean equals(Object obj) {
        ...
        CreateDatasinkResponse that = (CreateDatasinkResponse)obj;
