 ...
 */
public class AdminSendAlertResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("AdminSendAlertResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     */
    public AdminSendAlertResponse setInfo(Map<String, String> info) {
    ...
    public boolean equals(Object obj) {
        ...
        AdminSendAlertResponse that = (AdminSendAlertResponse)obj;
