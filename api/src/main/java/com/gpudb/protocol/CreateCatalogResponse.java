 ...
 */
public class CreateCatalogResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("CreateCatalogResponse")
            .namespace("com.gpudb")
            .fields()
    ...
    /**
     * Value of {@link com.gpudb.protocol.CreateCatalogRequest#getName() name}.
     *
     ...
     */
    public CreateCatalogResponse setName(String name) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public CreateCatalogResponse setInfo(Map<String, String> info) {
