 ...
 * com.gpudb.GPUdb#insertSymbol(InsertSymbolRequest) GPUdb.insertSymbol}.
 * <p>
...
public class InsertSymbolRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link InsertSymbolRequest} parameter
     * {@link #getSymbolFormat() symbolFormat}.
     * <p>
    ...
    public static final class Options {
        /**
         * If {@link #getSymbolFormat() symbolFormat} is 'svg' this is ignored.
         * If {@link #getSymbolFormat() symbolFormat} is 'svg_path' then this
         * option specifies the color (in RRGGBB hex format) of the path. For
         * example, to have the path rendered in red, used 'FF0000'. If 'color'
         * is not provided then '00FF00' (i.e.&nbsp;green) is used by default.
         */
     ...
     *                      Supported values:
     *                      <ul>
     *                          <li>{@link SymbolFormat#SVG SVG}
     *                          <li>{@link SymbolFormat#SVG_PATH SVG_PATH}
     *                      </ul>
     ...
     *                         symbolFormat} is 'svg' this is ignored. If
     *                         {@code symbolFormat} is 'svg_path' then this
     *                         option specifies the color (in RRGGBB hex
     *                         format) of the path. For example, to have the
     *                         path rendered in red, used 'FF0000'. If 'color'
     *                         is not provided then '00FF00' (i.e. green) is
     *                         used by default.
     *                 </ul>
     ...
     * </ul>
     *
     * @return The current value of {@code symbolFormat}.
     */
     ...
     * </ul>
     *
     * @param symbolFormat  The new value for {@code symbolFormat}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     * Optional parameters.
     * <ul>
     *     <li>{@link Options#COLOR COLOR}: If {@link #getSymbolFormat()
     *         symbolFormat} is 'svg' this is ignored. If {@link
     *         #getSymbolFormat() symbolFormat} is 'svg_path' then this option
