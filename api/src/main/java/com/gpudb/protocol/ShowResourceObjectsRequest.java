...
public class ShowResourceObjectsRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link ShowResourceObjectsRequest}
    ...
    public static final class Options {
        ...
        /**
         * An expression to filter the returned objects. Expression is limited
         ...
         * Supported values:
         * <ul>
         *     <li>{@link Options#SIZE SIZE}
         *     <li>{@link Options#ID ID}
         ...
         * allowed by the server should be returned.  The number of records
     ...
     *                 <ul>
     *                     <li>{@link Options#TIERS TIERS}: Comma-separated
     ...
     *                     <li>{@link Options#ORDER_BY ORDER_BY}: Single column
     ...
     *                         </ul>
     *                     <li>{@link Options#LIMIT LIMIT}: An integer
     ...
     *                         is '100'.
     *                     <li>{@link Options#TABLE_NAMES TABLE_NAMES}:
     ...
     * Optional parameters.
     * <ul>
     *     <li>{@link Options#TIERS TIERS}: Comma-separated list of tiers to
     *         query, leave blank for all tiers.
     *     <li>{@link Options#EXPRESSION EXPRESSION}: An expression to filter
     ...
     *         target="_top">Expressions</a>. To use a more complex expression,
     *         query the ki_catalog.ki_tiered_objects table directly.
     *     <li>{@link Options#ORDER_BY ORDER_BY}: Single column to be sorted by
     ...
     *                 OWNER_RESOURCE_GROUP}
     *         </ul>
     *     <li>{@link Options#LIMIT LIMIT}: An integer indicating the maximum
     ...
     *         target="_top">max_get_records_size</a> parameter in the server
     *         configuration. The default value is '100'.
     *     <li>{@link Options#TABLE_NAMES TABLE_NAMES}: Comma-separated list of
