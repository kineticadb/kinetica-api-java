 ...
 */
public class CreateDirectoryResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("CreateDirectoryResponse")
            .namespace("com.gpudb")
            .fields()
    ...
    /**
     * Value of {@link
     * com.gpudb.protocol.CreateDirectoryRequest#getDirectoryName()
     * directoryName}.
     *
     ...
     */
    public CreateDirectoryResponse setDirectoryName(String directoryName) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public CreateDirectoryResponse setInfo(Map<String, String> info) {
