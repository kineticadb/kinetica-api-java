...
public class ShowProcStatusResponse implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link ShowProcStatusResponse}
     * parameter {@link #getOverallStatuses() overallStatuses}.
     * <p>
     ...
     * run ID; see {@link #getStatuses() statuses} and {@link #getMessages()
     * messages} for statuses from individual data segments.
     */
    ...
    /**
     * A set of string constants for the {@link ShowProcStatusResponse}
     * parameter {@link #getStatuses() statuses}.
     * <p>
    ...
    /**
     * A set of string constants for the {@link ShowProcStatusResponse}
     * parameter {@link #getOutput() output}.
     * <p>
    ...
    /**
     * The string params passed to {@link
     * com.gpudb.GPUdb#executeProc(ExecuteProcRequest) GPUdb.executeProc} for
    ...
    /**
     * The binary params passed to {@link
     * com.gpudb.GPUdb#executeProc(ExecuteProcRequest) GPUdb.executeProc} for
     * the returned run IDs.
     *
    ...
    /**
     * The input table names passed to {@link
     * com.gpudb.GPUdb#executeProc(ExecuteProcRequest) GPUdb.executeProc} for
     * the returned run IDs.
     *
    ...
    /**
     * The input column names passed to {@link
     * com.gpudb.GPUdb#executeProc(ExecuteProcRequest) GPUdb.executeProc} for
    ...
    /**
     * The output table names passed to {@link
     * com.gpudb.GPUdb#executeProc(ExecuteProcRequest) GPUdb.executeProc} for
     * the returned run IDs.
     *
    ...
    /**
     * The optional parameters passed to {@link
     * com.gpudb.GPUdb#executeProc(ExecuteProcRequest) GPUdb.executeProc} for
     * the returned run IDs.
     *
     ...
     * Valid values are:
     * <ul>
     *     <li>{@link OverallStatuses#RUNNING RUNNING}: The proc instance is
     *         currently running.
     *     <li>{@link OverallStatuses#COMPLETE COMPLETE}: The proc instance
     *         completed with no errors.
     *     <li>{@link OverallStatuses#KILLED KILLED}: The proc instance was
     *         killed before completion.
     *     <li>{@link OverallStatuses#ERROR ERROR}: The proc instance failed
     *         with an error.
     *     <li>{@link OverallStatuses#NONE NONE}: The proc instance does not
     *         have a status, i.e. it has not yet ran.
     * </ul>
     *
     * @return The current value of {@code overallStatuses}.
     */
     ...
     * </ul>
     *
     * @param overallStatuses  The new value for {@code overallStatuses}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     * Valid values are:
     * <ul>
     *     <li>{@link Statuses#RUNNING RUNNING}: The proc instance is currently
     *         running.
     *     <li>{@link Statuses#COMPLETE COMPLETE}: The proc instance completed
     *         with no errors.
     *     <li>{@link Statuses#KILLED KILLED}: The proc instance was killed
     *         before completion.
     *     <li>{@link Statuses#ERROR ERROR}: The proc instance failed with an
     *         error.
     *     <li>{@link Statuses#NONE NONE}: The proc instance does not have a
     *         status, i.e. it has not yet ran.
     * </ul>
     *
     ...
     *
     * @return The current value of {@code results}.
     */
     ...
     * String results for the returned run IDs, grouped by data segment ID.
     *
     * @param results  The new value for {@code results}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     *
     * @return The current value of {@code binResults}.
     */
     ...
     * Binary results for the returned run IDs, grouped by data segment ID.
     *
     * @param binResults  The new value for {@code binResults}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     * Output lines for the returned run IDs, grouped by data segment ID.
     * <ul>
     *     <li>{@link Output#STDOUT STDOUT}: Output lines from stdout.
     *     <li>{@link Output#STDERR STDERR}: Output lines from stderr.
     * </ul>
     *
     * @return The current value of {@code output}.
     */
     ...
     * </ul>
     *
     * @param output  The new value for {@code output}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     *
     * @return The current value of {@code timings}.
     */
     ...
     * Timing information for the returned run IDs, grouped by data segment ID.
     *
     * @param timings  The new value for {@code timings}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
