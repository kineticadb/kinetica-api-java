...
public class CreateTableMonitorResponse implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link CreateTableMonitorResponse}
    ...
    /**
     * Value of {@link
     * com.gpudb.protocol.CreateTableMonitorRequest#getTableName() tableName}.
     *
     ...
     * Additional information.
     * <ul>
     *     <li>{@link Info#TTL TTL}: For insert_table/delete_table events, the
     *         ttl of the table.
     *     <li>{@link Info#INSERT_TOPIC_ID INSERT_TOPIC_ID}: The topic id for
     *         'insert' {@link
