...
public class GrantPermissionTableRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link GrantPermissionTableRequest}
     ...
     *                    Supported values:
     *                    <ul>
     *                        <li>{@link Permission#TABLE_ADMIN TABLE_ADMIN}:
     *                            Full read/write and administrative access to
     *                            the table.
     *                        <li>{@link Permission#TABLE_INSERT TABLE_INSERT}:
     *                            Insert access to the table.
     *                        <li>{@link Permission#TABLE_UPDATE TABLE_UPDATE}:
     *                            Update access to the table.
     *                        <li>{@link Permission#TABLE_DELETE TABLE_DELETE}:
     *                            Delete access to the table.
     *                        <li>{@link Permission#TABLE_READ TABLE_READ}:
     *                            Read access to the table.
     *                    </ul>
     ...
     *                 <ul>
     *                     <li>{@link Options#COLUMNS COLUMNS}: Apply security
     ...
     * Supported values:
     * <ul>
     *     <li>{@link Permission#TABLE_ADMIN TABLE_ADMIN}: Full read/write and
     *         administrative access to the table.
     *     <li>{@link Permission#TABLE_INSERT TABLE_INSERT}: Insert access to
     *         the table.
     *     <li>{@link Permission#TABLE_UPDATE TABLE_UPDATE}: Update access to
     *         the table.
     *     <li>{@link Permission#TABLE_DELETE TABLE_DELETE}: Delete access to
     *         the table.
     *     <li>{@link Permission#TABLE_READ TABLE_READ}: Read access to the
     *         table.
     * </ul>
     *
    ...
    /**
     * Optional filter expression to apply to this grant.  Only rows that match
     ...
     * Optional parameters.
     * <ul>
     *     <li>{@link Options#COLUMNS COLUMNS}: Apply security to these
