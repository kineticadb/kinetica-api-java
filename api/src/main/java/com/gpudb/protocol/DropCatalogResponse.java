 ...
 */
public class DropCatalogResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("DropCatalogResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     */
    public DropCatalogResponse() {
    }

    /**
     * Value of {@link com.gpudb.protocol.DropCatalogRequest#getName() name}.
     *
     ...
     */
    public DropCatalogResponse setName(String name) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public DropCatalogResponse setInfo(Map<String, String> info) {
    ...
    public boolean equals(Object obj) {
        ...
        DropCatalogResponse that = (DropCatalogResponse)obj;
