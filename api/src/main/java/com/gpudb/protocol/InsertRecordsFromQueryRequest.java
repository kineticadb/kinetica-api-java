...
public class InsertRecordsFromQueryRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link InsertRecordsFromQueryRequest}
    ...
    public static final class Options {
         ...
         * by {@link #getTableName() tableName} prior to loading the data.
         * Supported values:
         * <ul>
         *     <li>{@link Options#TRUE TRUE}
         *     <li>{@link Options#FALSE FALSE}
        ...
        /**
         * Name of column to be used for splitting the query into multiple
         * sub-queries using the data distribution of given column. The default
         * value is ''.
         */
     ...
     *                   or the type inferred from the remote query, and the
     ...
     * CreateTableOptions#TYPE_ID TYPE_ID} or the type inferred from the remote
     * query, and the new table name will have to meet standard <a
     * href="../../../../../../concepts/tables/#table-naming-criteria"
     * target="_top">table naming criteria</a>.
     *
     ...
     *         #getTableName() tableName} prior to loading the data.
     *         Supported values:
     *         <ul>
     *             <li>{@link Options#TRUE TRUE}
     *             <li>{@link Options#FALSE FALSE}
