...
public class RevokePermissionProcRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link RevokePermissionProcRequest}
     ...
     *                    Supported values:
     *                    <ul>
     *                        <li>{@link Permission#PROC_ADMIN PROC_ADMIN}:
     *                            Admin access to the proc.
     *                        <li>{@link Permission#PROC_EXECUTE PROC_EXECUTE}:
     *                            Execute access to the proc.
     *                    </ul>
     ...
     * Supported values:
     * <ul>
     *     <li>{@link Permission#PROC_ADMIN PROC_ADMIN}: Admin access to the
     *         proc.
     *     <li>{@link Permission#PROC_EXECUTE PROC_EXECUTE}: Execute access to
     *         the proc.
     * </ul>
     *
     ...
     * existing proc, or an empty string if the permission grants access to all
     * procs.
     *
