...
public class CreateVideoRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link CreateVideoRequest} parameter
     * {@link #getStyle() style}.
     * <p>
     * The name of the visualize mode; should correspond to the schema used for
     * the {@link #getStyleParameters() styleParameters} field.
     */
    ...
    public static final class Options {
        ...
        /**
         * Specified using the data-type corresponding to the {@link
         * #getAttribute() attribute}. For a window of size W, a video frame
        ...
        /**
         * If {@link Options#TRUE TRUE}, does not return an error if the video
         * already exists.  Ignored if {@link Options#REPLACE_IF_EXISTS
         * REPLACE_IF_EXISTS} is {@link Options#TRUE TRUE}.
         * Supported values:
         * <ul>
        ...
        /**
         * If {@link Options#TRUE TRUE}, deletes any existing video with the
     ...
     *               Supported values:
     *               <ul>
     *                   <li>{@link Style#CHART CHART}
     *                   <li>{@link Style#RASTER RASTER}
     *                   <li>{@link Style#CLASSBREAK CLASSBREAK}
     *                   <li>{@link Style#CONTOUR CONTOUR}
     *                   <li>{@link Style#HEATMAP HEATMAP}
     *                   <li>{@link Style#LABELS LABELS}
     *               </ul>
     * @param path  Fully-qualified <a href="../../../../../../tools/kifs/"
     *              target="_top">KiFS</a> path.  Write access is required. A
     *              file must not exist at that path, unless {@link
     *              Options#REPLACE_IF_EXISTS REPLACE_IF_EXISTS} is {@link
     *              Options#TRUE TRUE}.
     ...
     *                         href="../../../../../../concepts/ttl"
     *                         target="_top">TTL</a> of the video.
     *                     <li>{@link Options#WINDOW WINDOW}: Specified using
     *                         the data-type corresponding to the {@code
     *                         attribute}. For a window of size W, a video
     ...
     *                         already exists.  Ignored if {@link
     *                         Options#REPLACE_IF_EXISTS REPLACE_IF_EXISTS} is
     ...
     *                         FALSE}.
     *                     <li>{@link Options#REPLACE_IF_EXISTS
     *                         REPLACE_IF_EXISTS}: If {@link Options#TRUE
    ...
    /**
     * The animated attribute to map to the video's frames. Must be present in
     * the LAYERS specified for the visualization. This is often a time-related
     * field but may be any numeric type.
     *
     * @return The current value of {@code attribute}.
     */
     ...
     * field but may be any numeric type.
     *
     * @param attribute  The new value for {@code attribute}.
     *
    ...
    /**
     * The start point for the video. Accepts an expression evaluable over the
     * {@link #getAttribute() attribute}.
     *
     * @return The current value of {@code begin}.
     */
     ...
     * {@link #getAttribute() attribute}.
     *
     * @param begin  The new value for {@code begin}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
    ...
    /**
     * The end point for the video. Accepts an expression evaluable over the
     * {@link #getAttribute() attribute}.
     *
     ...
     *
     * @return The current value of {@code framesPerSecond}.
     */
     ...
     * The presentation frame rate of the encoded video in frames per second.
     *
     * @param framesPerSecond  The new value for {@code framesPerSecond}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     * </ul>
     *
     * @return The current value of {@code style}.
     */
     ...
     * </ul>
     *
     * @param style  The new value for {@code style}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     * exist at that path, unless {@link Options#REPLACE_IF_EXISTS
     * REPLACE_IF_EXISTS} is {@link Options#TRUE TRUE}.
     *
    ...
    /**
     * A string containing the JSON-encoded visualize request.  Must correspond
     * to the visualize mode specified in the {@link #getStyle() style} field.
     *
     * @return The current value of {@code styleParameters}.
     */
     ...
     * to the visualize mode specified in the {@link #getStyle() style} field.
     *
     * @param styleParameters  The new value for {@code styleParameters}.
     *
     * @return {@code this} to mimic the builder pattern.
     */
     ...
     *         the video.
     *     <li>{@link Options#WINDOW WINDOW}: Specified using the data-type
     *         corresponding to the {@link #getAttribute() attribute}. For a
     ...
     *         Options#TRUE TRUE}, does not return an error if the video
     *         already exists.  Ignored if {@link Options#REPLACE_IF_EXISTS
     *         REPLACE_IF_EXISTS} is {@link Options#TRUE TRUE}.
     *         Supported values:
     *         <ul>
     ...
     *         </ul>
     *         The default value is {@link Options#FALSE FALSE}.
     *     <li>{@link Options#REPLACE_IF_EXISTS REPLACE_IF_EXISTS}: If {@link
     *         Options#TRUE TRUE}, deletes any existing video with the same
     *         path before creating a new video.
     *         Supported values:
     *         <ul>
     *             <li>{@link Options#FALSE FALSE}
