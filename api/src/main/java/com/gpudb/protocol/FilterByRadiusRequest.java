 ...
 * com.gpudb.GPUdb#filterByRadius(FilterByRadiusRequest) GPUdb.filterByRadius}.
 * <p>
 ...
 * specification is also created if a {@link #getViewName() viewName} is passed
...
public class FilterByRadiusRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link FilterByRadiusRequest}
    ...
    public static final class Options {
         ...
         * returned in {@link
         * com.gpudb.protocol.FilterByRadiusResponse.Info#QUALIFIED_VIEW_NAME
         * QUALIFIED_VIEW_NAME}.
         * Supported values:
         * <ul>
         ...
         * schema which is to contain the newly created view. If the schema is
    ...
    /**
     * Name of the column to be used for the x-coordinate (the longitude) of
     * the center.
     *
    ...
    /**
     * Name of the column to be used for the y-coordinate-the latitude-of the
     * center.
     *
