 ...
 */
public class DropDatasinkResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("DropDatasinkResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     */
    public DropDatasinkResponse() {
    }

    /**
     * Value of {@link com.gpudb.protocol.DropDatasinkRequest#getName() name}.
     *
     ...
     */
    public DropDatasinkResponse setName(String name) {
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public DropDatasinkResponse setInfo(Map<String, String> info) {
    ...
    public boolean equals(Object obj) {
        ...
        DropDatasinkResponse that = (DropDatasinkResponse)obj;
