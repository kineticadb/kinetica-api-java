...
public class CreateResourceGroupRequest implements IndexedRecord {
    ...
    /**
     * A set of string constants for the {@link CreateResourceGroupRequest}
    ...
    /**
     * Name of the group to be created. Must contain only letters, digits, and
     * underscores, and cannot begin with a digit. Must not match existing
     * resource group name.
     *
