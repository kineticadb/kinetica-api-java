 ...
 */
public class CreateCredentialResponse implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("CreateCredentialResponse")
            .namespace("com.gpudb")
            .fields()
     ...
     * 
     */
    public CreateCredentialResponse setCredentialName(String credentialName) {
     ...
     * 
     */
    public CreateCredentialResponse setInfo(Map<String, String> info) {
