 ...
 */
public class RevokePermissionCredentialRequest implements IndexedRecord {
    private static final Schema schema$ = SchemaBuilder
            .record("RevokePermissionCredentialRequest")
            .namespace("com.gpudb")
            .fields()
     ...
     * RevokePermissionCredentialRequest} parameter {@link #getPermission()
     * permission}.
     * <p>
    ...
    /**
     * Constructs a RevokePermissionCredentialRequest object with the specified
     * parameters.
     *
     ...
     *                 {@link Map}.
     */
    public RevokePermissionCredentialRequest(String name, String permission, String credentialName, Map<String, String> options) {
     ...
     */
    public RevokePermissionCredentialRequest setName(String name) {
        this.name = (name == null) ? "" : name;
        return this;
    }
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public RevokePermissionCredentialRequest setPermission(String permission) {
        this.permission = (permission == null) ? "" : permission;
        return this;
    }

    /**
     * Name of the credential on which the permission will be revoked. Must be
     * an existing credential, or an empty string to revoke access on all
     * credentials.
     *
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public RevokePermissionCredentialRequest setCredentialName(String credentialName) {
        this.credentialName = (credentialName == null) ? "" : credentialName;
        return this;
    }
     ...
     * @return {@code this} to mimic the builder pattern.
     */
    public RevokePermissionCredentialRequest setOptions(Map<String, String> options) {
        this.options = (options == null) ? new LinkedHashMap<String, String>() : options;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        RevokePermissionCredentialRequest that = (RevokePermissionCredentialRequest)obj;
