...
public class AdminShowAlertsRequest implements IndexedRecord {
    ...
    /**
     * Number of most recent alerts to request. The response will include up to
     * {@link #getNumAlerts() numAlerts} depending on how many alerts there are
     * in the system. A value of 0 returns all stored alerts.
     *
     * @return The current value of {@code numAlerts}.
     */
     ...
     * in the system. A value of 0 returns all stored alerts.
     *
     * @param numAlerts  The new value for {@code numAlerts}.
     *
