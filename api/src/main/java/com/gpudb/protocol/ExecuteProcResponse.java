...
public class ExecuteProcResponse implements IndexedRecord {
    ...
    /**
     * The run ID of the running proc instance. This may be passed to {@link
     * com.gpudb.GPUdb#showProcStatus(ShowProcStatusRequest)
     * GPUdb.showProcStatus} to obtain status information, or {@link
     * com.gpudb.GPUdb#killProc(KillProcRequest) GPUdb.killProc} to kill the
     * proc instance.
     *
